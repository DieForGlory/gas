            ...
            token ? (
              <Layout>
                <Routes>
                  ...
                  <Route path="/firmware" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN']}><Firmware /></ProtectedRoute>} />
                  <Route path="/users" element={<ProtectedRoute allowedRoles={['ADMIN','SUPER_ADMIN', 'REGIONAL']}><UsersPage /></ProtectedRoute>} />
                  <Route path="/audit" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN']}><Audit /></ProtectedRoute>} />
                  <Route path="/valve-types" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN']}><ValveTypesPage /></ProtectedRoute>} />
